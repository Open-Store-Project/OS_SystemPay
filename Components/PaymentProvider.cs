...
{
    public class OS_SystemPayPaymentProvider : Nevoweb.DNN.NBrightBuy.Components.Interfaces.PaymentsInterface
    {
        ...
        public override string GetTemplate(NBrightInfo cartInfo)
        {
            ...
            var info = objCtrl.GetPluginSinglePageData("OS_SystemPaypayment", "OS_SystemPayPAYMENT", Utils.GetCurrentCulture());
            ...
            templ = NBrightBuyUtils.RazorTemplRender(templateName, 0, "", info, "/DesktopModules/NBright/OS_SystemPay", "config", Utils.GetCurrentCulture(), passSettings);
